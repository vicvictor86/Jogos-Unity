...
public class CameraSegue : MonoBehaviour
{
    ...
    [SerializeField] private Transform objE = null, objD = null, bola;
    private float t = 1;
    ...
    void Update()
    {
        ...
        {
            if (transform.position.x != objE.position.x && GameManager.instance.chutesBola == 1)
            {
            ...
            {
                bola = GameObject.Find(OndeEstou.instance.bolaEmUso + "(Clone)").GetComponent<Transform>();
            }
